...
class Parser(models.AbstractModel):
    _name = 'report.itsys_real_estate.report_late_payments_customers'
    ...
    def get_report_values(self, docids, data=None):
        ...
        due_payment = self.env['ir.actions.report']._get_report_from_name('itsys_real_estate.report_late_payments_customers')
